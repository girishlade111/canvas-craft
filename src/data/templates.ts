  ...
  sections: [
    ...
    },
    {
      ...
      components: [
        ...
        { id: 'body-text', type: 'paragraph', category: 'Text', label: 'Body Text', content: 'Start building your website by dragging components from the left sidebar onto this canvas. Click any element to edit its properties.', styles: { fontSize: '18px', textAlign: 'center', color: '#6b7280', margin: '0 auto', maxWidth: '600px' } as any },
      ],
    },
    {
      id: 'footer-1',
  ...
  sections: [
    blankSchema.sections[0],
    {
      ...
      components: [
        ...
        { id: 'landing-p', type: 'paragraph', category: 'Text', label: 'Subtitle', content: 'Create stunning websites without writing a single line of code. Or write all the code you want.', styles: { fontSize: '20px', color: '#6b7280', maxWidth: '640px', margin: '0 auto' } as any },
      ],
    },
    blankSchema.sections[3],
  ],
...
export const templates: Template[] = [
  { id: 'blank', name: 'Blank', description: 'Start from scratch with a minimal layout', category: 'starter', thumbnail: '🗒️', schema: blankSchema },
  { id: 'blog', name: 'Blog', description: 'A clean blog with posts grid', category: 'content', thumbnail: '📝', schema: blogSchema },
  { id: 'business', name: 'Business', description: 'Professional business website', category: 'business', thumbnail: '🏢', schema: businessSchema },
  { id: 'landing', name: 'Landing Page', description: 'High-converting landing page', category: 'marketing', thumbnail: '🚀', schema: landingSchema },
  { id: 'ecommerce', name: 'Ecommerce', description: 'Online store with product grid', category: 'commerce', thumbnail: '🛒', schema: ecommerceSchema },
];
