...
import {
  ...
  School, Library, ClipboardList, Briefcase, Lightbulb, Puzzle, Gamepad2, Dice1,
  ...
  Activity, Anchor, Aperture, Box, Boxes, Braces, Cable, Calculator, CircleDot,
  Clapperboard, Clipboard, Codesandbox, Coins, Command, Contrast, Cookie,
  CornerDownLeft, CornerDownRight, CornerLeftDown, CornerLeftUp,
  CornerRightDown, CornerRightUp, CornerUpLeft, CornerUpRight, Crop,
  Disc, Divide, DoorClosed, DoorOpen, Dribbble, Droplets, Egg, Equal, Eraser, Euro,
  Expand, Facebook, Feather, Figma, FileCheck, FileCode, FileImage, FileMinus,
  FileMusic, FileOutput, FilePlus, FileSpreadsheet, FileStack, FileVideo, FileX, Files,
  Film, Fingerprint, Fish, FlagOff, FlameKindling, Flashlight, FlaskConical, FlaskRound,
  Focus, FolderMinus, FolderOpen, FolderPlus, FolderTree, Folders, Forklift, Forward,
  Frame, Framer, Fuel, Fullscreen, Gauge, GlassWater, Glasses, Grape, Grip, GripHorizontal,
  GripVertical, Group, HandMetal, HardDrive, HardHat, Headset, HeartCrack, HeartHandshake,
  HeartOff, HeartPulse, HelpingHand, Hexagon, History, Hourglass, IceCream,
  ImageMinus, ImageOff, ImagePlus, IndianRupee, Instagram, IterationCcw, IterationCw,
  JapaneseYen, Joystick, Kanban, Lamp, LampCeiling, LampDesk, LampFloor, LandPlot,
  LaptopMinimal, Lasso, LassoSelect, Layers2, Github, Gitlab,
} from 'lucide-react';
